...
namespace Disk.Migrations
{
    ...
    [Migration("20250504204030_RenamedIndexes")]
    partial class RenamedIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Disk.Entities.Attempt", b =>
                {
                    ...
                    b.Property<double>("MaxXAngle")
                        .HasColumnType("REAL")
                        .HasColumnName("att_max_x_angle");

                    b.Property<double>("MaxYAngle")
                        .HasColumnType("REAL")
            ...
            modelBuilder.Entity("Disk.Entities.PathInTarget", b =>
                {
                    ...
                    b.Property<double>("Accuracy")
                        .HasColumnType("REAL")
                        .HasColumnName("pit_accuracy");

                    b.Property<double>("ConvexHullArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(0.0)
                        .HasColumnName("pit_convex_hull_area");
                    ...
                    b.Property<double>("EllipseArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(0.0)
                        .HasColumnName("pit_ellipse_area");

                    b.Property<double>("FullPathConvexHullArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(0.0)
                        .HasColumnName("pit_full_path_convex_hull_area");

                    b.Property<double>("FullPathEllipseArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(0.0)
                        .HasColumnName("pit_full_path_ellipse_area");
