...
{
    class Point2D<CoordType> where CoordType : IConvertible, new()
    {
        ...
        public static double GetDistance(Point2D<CoordType> p1, Point2D<CoordType> p2, IFormatProvider? formatProvider)
            => Math.Sqrt
            (
