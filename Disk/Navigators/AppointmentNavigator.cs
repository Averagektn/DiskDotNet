...
namespace Disk.Navigators
{
    public class AppointmentNavigator : INavigator
    {
        ...
        public static void NavigateAndClose(INavigationStore navigationStore, List<Session> sessions, Patient patient, Appointment appointment)
        {
        ...
        public static void NavigateWithBar(INavigationStore navigationStore, List<Session> sessions, Patient patient, Appointment appointment)
        {
        ...
        public static void NavigateWithBarAndClose(INavigationStore navigationStore, List<Session> sessions, Patient patient, Appointment appointment)
        {
            if (navigationStore.CanClose)
            {
                navigationStore.Close();
