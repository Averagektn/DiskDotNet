...
namespace Disk.Navigators
{
    ...
    {
        public static void Navigate(INavigationStore navigationStore, string imageFilePath, string logPath, Action? onSessionOver, Session session)
        {
        ...
        public static void NavigateWithBarAndClose(INavigationStore navigationStore, string imageFilePath, string logPath, Action? onSessionOver,
            Session session)
        {
            if (navigationStore.CanClose)
            {
